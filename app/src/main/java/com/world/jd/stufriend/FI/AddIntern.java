...
public class AddIntern extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("interns").push();
            ...
            protected void onBindViewHolder(ViewHolder holder, final int position, Model model) {
                ...
                holder.view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(getApplicationContext(),FIItems.class);
    ...
    public void viewInterns(View view) {
        startActivity(new Intent(getApplicationContext(),FIList.class));
    }
}