...
public class TCSQuesItems extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_t_c_s_ques_items);
        textViewTitle=findViewById(R.id.list_title);
        textViewDesc=findViewById(R.id.list_desc);
        reference= FirebaseDatabase.getInstance().getReference().child("TCS Questions");
