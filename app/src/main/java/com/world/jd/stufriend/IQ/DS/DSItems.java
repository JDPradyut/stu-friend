...
public class DSItems extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_d_s_items);
        textViewTitle=findViewById(R.id.list_title);
        textViewDesc=findViewById(R.id.list_desc);
        reference= FirebaseDatabase.getInstance().getReference().child("Data Structure");
